...
Java_com_lg_ndk_util_CompressImageUtil_compressBitmap(JNIEnv *env, jclass type, jobject bitmap,
                                                      jint quality, jstring outFileName_,
                                                      jboolean optimize, jboolean recycle) {
    return compress_image(env,type,bitmap,quality,outFileName_,optimize,recycle);
}
extern "C"
JNIEXPORT jstring JNICALL
Java_com_lg_ndk_util_NativeUtil_compressBitmap(JNIEnv *env, jclass clazz, jobject bit, jint w,
    ...
    AndroidBitmap_lockPixels(env,bit,(void**)&pixelscolor);
...
//          a = ((color & 0xFF000000) >> 24);
    ...
    char* fileName = jstrinTostring(env,file_name_bytes);
    //调用libjpeg核心方法实现压缩
